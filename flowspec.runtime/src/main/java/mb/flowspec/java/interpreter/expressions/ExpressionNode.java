...
import mb.flowspec.java.interpreter.Types;
import mb.flowspec.java.interpreter.values.Name;
import mb.flowspec.java.solver.ParseException;
...
public abstract class ExpressionNode extends Node {
    ...
    public mb.flowspec.java.interpreter.values.Set<ITerm> executeSet(VirtualFrame frame) throws UnexpectedResultException {
