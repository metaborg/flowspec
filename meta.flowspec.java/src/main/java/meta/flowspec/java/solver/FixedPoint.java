...
public class FixedPoint {
    ...
    public ISolution entryPoint(ISolution nabl2solution, TFFileInfo tfFileInfo) {
         ...
         */
        tfFileInfo.init(ImmutableInitValues.of(cfg, this.preProperties, nabl2solution.scopeGraph(), nabl2solution.nameResolution(), nabl2solution.unifier(), nabl2solution.astProperties()));
